---
title: "2024–2024–2025 AAC Accident Reports - Exploratory Analysis"
date: "`r Sys.Date()`"
...
accident_data %>%
  ...
  labs(
    ...
    subtitle = "Top 20 states, 2024–2025",
    x = "Reports",
    y = NULL
  )
...
accident_data %>%
  ...
  labs(
    ...
    subtitle = "Top 20 states by total injuries, 2024–2025",
    x = "People",
    y = NULL
  )
...
accident_data %>%
  ...
  labs(
    ...
    subtitle = "2024–2025 - Reports with multiple causes counted once per cause",
    x = "Reports",
    y = NULL
  )
...
accident_data %>%
  ...
  labs(
    ...
    subtitle = "2024–2025 - Accidents with multiple causes counted once per cause",
    x = "People",
    y = NULL
  )
...
accident_data %>%
  ...
  labs(
    ...
    subtitle = "2024–2025 - Excludes solo climbers and reports with no party size data",
    x = "Party Size",
    y = "Reports"
  )
...
accident_data %>%
  ...
  labs(
    ...
    subtitle = "2024–2025 - Grades simplified to nearst full grade (e.g. 5.10a = 5.10)",
    x = "YDS Grade",
    y = "Injuries"
  )
