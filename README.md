...
This project is inspired the work by Eliot Caroom. His natural langauge analysis of accident reports can also be found on [GitHub](https://github.com/ecaroom/climbing-accidents/tree/master).

## Project Goals

- [x] Build a structured dataset from publicly available AAC accident reports
- [x] Use LLM-assisted extraction to tag risk factors, climbing style, injury severity, and location from unstructured article text
